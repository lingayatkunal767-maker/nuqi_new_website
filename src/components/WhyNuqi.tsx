            ...
            <Card className={cn("flex h-full overflow-hidden", CARD_HOVER)}>
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  <svg
                    className="absolute inset-0 size-full text-white/[0.04]"
                    viewBox="0 0 254 104"
                    fill="none"
                ...
                <h3 className="mt-6 text-center text-2xl font-medium text-white">
                  Transparent
                </h3>
                ...
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                  <svg className="m-auto h-fit w-24 text-gold" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill="currentColor"
                    />
                    <path className="text-gold" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                  </svg>
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h3 className="text-lg font-medium text-white">SEBI Registered</h3>
                  <p className="text-sm text-fg-muted">
                    Every recommendation moves through licensed, regulated
                    hands — never silicon alone.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={cn("h-full overflow-hidden", CARD_HOVER)}>
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  <svg className="w-full text-white/10" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill="url(#nuqi-chart-fill)"
                    />
                    <path
                      className="text-gold"
                      d="M1 121.077C1 121.077 15.3041 93.6691 36.0195 87.756C56.7349 81.8429 66.6632 80.9723 66.6632 80.9723C66.6632 80.9723 80.0327 80.9723 91.4656 80.9723C102.898 80.9723 100.415 64.2824 108.556 64.2824C116.696 64.2824 117.693 92.1332 125.226 92.1332C132.759 92.1332 142.07 78.5115 153.591 80.9723C165.113 83.433 186.092 92.1332 193 92.1332C199.908 92.1332 205.274 64.2824 213.017 64.2824C220.76 64.2824 237.832 93.8946 243.39 92.1332C248.948 90.3718 257.923 60.5 265.284 60.5C271.145 60.5 283.204 87.7182 285.772 87.756C293.823 87.8746 299.2 73.0802 304.411 73.0802C311.283 73.0802 321.425 65.9506 333.552 64.2824C345.68 62.6141 346.91 82.4553 362.27 80.9723C377.629 79.4892 383 106.605 383 106.605"
                      stroke="currentColor"
                      strokeWidth="3"
                    />
                    <defs>
                      <linearGradient id="nuqi-chart-fill" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                        <stop className="text-gold/25" stopColor="currentColor" />
                ...
                <div className="relative z-10 mt-10 space-y-2 text-center">
                  <h3 className="text-lg font-medium text-white">Live, Always</h3>
                  <p className="text-sm text-fg-muted">
                    Your entire portfolio, one glance away — updated the
              ...
              <CardContent className="grid gap-8 pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-8">
                  <div className="relative flex aspect-square size-12 rounded-full border border-gold/30 bg-gradient-to-br from-[#e1c66a]/20 to-transparent before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                    <Sparkles className="m-auto size-5 text-gold" strokeWidth={1.5} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium text-white">
                      Advice, Sharpened by Data
                    </h3>
                    <p className="text-sm text-fg-muted">
                      Our Robo Advisory reads market trends in real time and
                      tailors every recommendation to your risk profile —
                      intelligence you can act on, not just observe.
                    </p>
                  </div>
                </div>
                <div className="relative -mb-6 -mr-6 mt-6 h-fit rounded-tl-2xl border-l border-t border-white/10 p-6 sm:ml-6">
                  <div className="absolute left-3 top-2 flex gap-1">
                    <span className="block size-2 rounded-full border border-white/10 bg-white/10" />
                    <span className="block size-2 rounded-full border border-white/10 bg-white/10" />
                    <span className="block size-2 rounded-full border border-white/10 bg-white/10" />
                  </div>
                  <svg className="w-full text-white/10 sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
          ...
          <RevealItem className="col-span-full lg:col-span-3">
            <Card className={cn("h-full overflow-hidden", CARD_HOVER)}>
              <CardContent className="grid h-full gap-8 pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-8">
                  <div className="relative flex aspect-square size-12 rounded-full border border-gold/30 bg-gradient-to-br from-[#e1c66a]/20 to-transparent before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                    <Users className="m-auto size-5 text-gold" strokeWidth={1.5} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium text-white">
                      A Team, Not Just an App
                    </h3>
                    <p className="text-sm text-fg-muted">
                      Behind every algorithm is a licensed advisory team — for
                      the moments that need a human, not just a model.
                    </p>
                  </div>
                </div>
                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-white/10 sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    {SEGMENTS.map((segment, i) => (
                      ...
                      >
                        {i % 2 === 0 && (
                          <span className="block h-fit rounded border border-white/10 bg-panel px-2 py-1 text-xs text-fg-muted shadow-sm">
                            {segment}
                          </span>
                        )}
                        <div className="flex size-8 items-center justify-center rounded-full border border-gold/30 bg-void text-[10px] font-medium text-gold ring-4 ring-void">
                          {segment
                            .split(" ")
                            .map((w) => w[0])
                            .join("")
